...
var resolveFetch = (customFetch) => {
  ...
  if (customFetch) {
    ...
    _fetch = (...args) => __awaiter(void 0, void 0, void 0, function* () {
      return yield (yield import("./browser-ponyfill-SL225SQD.js")).fetch(...args);
    });
  } else {
    _fetch = fetch;
  }
...
var resolveResponse = () => __awaiter5(void 0, void 0, void 0, function* () {
  if (typeof Response === "undefined") {
    return (yield import("./browser-ponyfill-SL225SQD.js")).Response;
  }
  return Response;
});
...
var resolveFetch4 = (customFetch) => {
  ...
  if (customFetch) {
    ...
    _fetch = async (...args) => await (await import("./browser-ponyfill-SL225SQD.js")).fetch(...args);
  } else {
    _fetch = fetch;
  }
  return (...args) => _fetch(...args);
...
var STACK_GUARDS_SUPPORTED = false;
...
var STACK_GUARD_WARNING_LOGGED = false;
  ...
  async _getSessionFromURL(isPKCEFlow) {
    try {
      ...
      if (isPKCEFlow) {
        ...
        const { data: data2, error: error2 } = await this.exchangeCodeForSession(params.code);
        if (error2)
          throw error2;
